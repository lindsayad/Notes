...
1) Abrupt transition between slides 26 and 27
2) Explain why we ever added baking soda and why we explored its effects on the solution chemistry
3) Further bridge between modelling and experiments and applications.

Presentation notes from Steve:

1) Flip interfacial concentration and hydrophobic uptake slides
2) Highlight questions
3) Slide 28: give full name for PFOS and PFOA
4) Slide 36-37: delete character in title
5) Slide 59: Get rid of separation between our group and community
